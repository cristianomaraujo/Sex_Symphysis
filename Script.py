# -*- coding: utf-8 -*-
"""VERSAO FINAL de Sinfise - Aline com IC95%

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1FBS8Z_3RYCqMH_aDx3ngKBy-8IlgKW_W
...
colunas = ['sex', 'alt sinf', 'larg sinf']
...
colunas_out = ['alt sinf', 'larg sinf']

# Criar uma máscara para identificar linhas sem outliers nas colunas de interesse
mascara = pd.Series([True] * len(df))

# Atualizar a máscara para cada coluna
for coluna in colunas_out:
    ...
    # Atualizar a máscara para excluir outliers
    mascara = mascara & (df[coluna] >= lim_inferior) & (df[coluna] <= lim_superior)

# Aplicar a máscara a todo o DataFrame para remover as linhas com outliers
df = df[mascara]

# Exibir o DataFrame sem outliers, mantendo as mesmas linhas nas colunas de interesse
print("DataFrame sem outliers nas colunas especificadas, com a mesma dimensionalidade:")
print(df)
